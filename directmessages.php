...
<?php
 $currentchat = $_SESSION['currentchat'];
		...
		$chat_query="SELECT * FROM chat_msg WHERE (sender_id='$log_username' OR sender_id='$currentchat') AND (reciever_id='$currentchat' OR reciever_id='$log_username')  ORDER BY date_time";
       ...
       $fileType = '';
               ...
               if($chat_row->status==1)
				...
				if($chat_row->sender_id==$log_username)
