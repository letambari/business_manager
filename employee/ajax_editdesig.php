...
$sql = "SELECT * FROM designation WHERE user_id = '$log_id' AND company_id = '$log_username' AND designation_id = '$editdeptid'";
...
if ($count_employee == 1) {
	# code...
	$sql = "UPDATE designation SET designation_name = '$editdept' WHERE company_id = '$log_username' AND user_id = '$log_id' AND designation_id = '$editdeptid'";
	$query = mysqli_query($db_conx, $sql);
	if ($query) {
		# code...
		echo "Designation Details Updated!";
	}else{
