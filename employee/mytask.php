...
while ($row_p = mysqli_fetch_array($query_p)) {
    ...
    echo '<li> 
                                <a href="mytask.php?project='.$project_title.'&pid='.$project_id.'">'.$project_title.'</a>
                            </li>';
}
                            ?>
                                                    ...
                                                    <div class="task-list-container">
                                                        ...
                                                        <div class="task-list-footer">
                                                            <div class="new-task-wrapper">
                                                                ...
                                                                <input type="text" id="Description2" value="<?php echo $pid; ?>" >
                            ...
                            <div class="chat-window">
                                ...
                                <div class="chat-contents task-chat-contents">
                                    <div class="chat-content-wrap">
                                        <div class="chat-wrap-inner">
                                            <div class="chat-box">
                                               <h5 style="text-align: center; padding-top: 5px;">Edit Task</h5>
                                                    <hr class="task-line">
                                                    <div class="task-desc">
