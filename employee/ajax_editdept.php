...
if ($count_employee == 1) {
	# code...
	$sql = "UPDATE departments SET department_name = '$editdept' WHERE company_id = '$log_username' AND user_id = '$log_id' AND department_id = '$editdeptid'";
	$query = mysqli_query($db_conx, $sql);
	if ($query) {
		# code...
		echo "Department Details Updated!";
	}else{
