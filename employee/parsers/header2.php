    ...
    $("#fileInput").change(function(){
        ...
        for(i = 0; i < fileLength; i++){ 
            ...
            if(((imagefile==match[0]))){
                alert('Please this file is not allowed (MP4).');
                $("#fileInput").val('');
                return false;
            }
        }
            ...
            <div class="header">
                ...
                -->
                   ...
                   <!-- Message Notifications -->
                       <li class="nav-item dropdown">
                        <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                            <i class="fa fa-comment-o"></i> <span class="badge count"></span>
                        </a>
                        <div class="dropdown-menu notifications">
                            <div class="topnav-dropdown-header">
                ...
                <div class="sidebar-inner slimscroll">
                    <div class="sidebar-menu">
                        <ul>
                            ...
                            <li class="menu-title">Contacts Chats <!-- <a href="#" data-toggle="modal" data-target="#add_chat_user"><i class="fa fa-plus"></i></a> --></li>
