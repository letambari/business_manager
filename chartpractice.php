...
$month=date("F",$time);
$year=date("Y",$time);
 $chart_data .= "{ year:'".$month."', profit:".$row["order_total_amount_due"].", purchase:".$row["grand_total"].", expense:".$row["order_amount_paid"]."}, ";
}
...
?>
 ...
 xkey:'year',
 ykeys:['purchase', 'profit', 'expense'],
 labels:['Total Invoice', 'Unpaid', 'expense'],
		lineColors: ['green','#0253cc','yellow'],
		lineWidth: '3px',
		barColors: ['green','red'],
		resize: true,
		redraw: true
