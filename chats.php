...
include 'parsers/header2.php'; 
    ...
    <form id="uploadForm" enctype="multipart/form-data">
        ...
        <input type="hidden" id="sender_id" name="sender_id" value="<?php echo $log_username; ?>">
        <input type="hidden" id="reciever_id" name="reciever_id" value="<?php echo $_SESSION['currentchat']; ?>">
        <input type="hidden" id="sender_fullname" name="sender_fullname"  value="<?php echo $ContactPerson; ?>">
    </div>
