											...
											<div class="row">
												<div class="col-md-5">
													<div class="profile-info-left">
														...
														<div class="staff-msg"><a class="btn btn-custom" href="chats?currentchat=<?php echo $ee_username;?>">Send Message</a> <a class="btn btn-danger" href="deletemp.php?empd=<?php echo $ee_employeee_id; ?>">Delete</a></div>
													</div>
												</div>
												<div class="col-md-7">
