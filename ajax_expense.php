...
$sql_count_invoice = "SELECT * FROM expense WHERE company_id = '$log_username' AND user_id = '$log_id' AND expensenumber = '$invoicenumber'";
...
$invoice_id = $row_count_invoice['expense_id'];
...
if ($count_invoice >= 1) {
	...
	// 'yes';
	//exit();
	$insert = "UPDATE expense SET status = '$invoicestatus', paymentmethod = '$paymentmethod', paymentdate = '$paymentdate' WHERE expensenumber = '$invoicenumber' AND user_id = '$log_id'";		
